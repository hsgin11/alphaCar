...
.agree{
	...
	overflow: auto;
	padding: 30px;
	border: 1px solid rgb(232,193,147);	
}
...
<body>
	...
	<div class="container">
		...
		<form:form action="step2" method="post" modelAttribute="user" cssClass="form1">
				<div class="">
					<h3 style="padding: 30px;">회원가입 1단계</h3>
					<hr>
				</div>
					
					<div class="agree">
						<p>AlphaCar 사이트에 오신것을 환영합니다.
						<p>AlphaCar 서비스 및 제품(이하 ‘서비스’)을 이용해 주셔서 감사합니다.
				...
				<div class="agree2">
						<label> 이용약관 동의 <span class="required ">(필수)</span> <form:checkbox
								path="agreeYn" value="Y" /> <form:errors path="agreeYn" />
						</label>
					</div>
				...
				<div class="">
					...
					<div class="agree2">
						<label> 개인정보 수집 및 이용에 대한 동의 <span class="required">(필수)</span>
							<form:checkbox path="privacyYn" value="Y" /> <form:errors
								path="privacyYn" />
						</label>
					</div>
				</div>
				<div class="">
					...
					<div class="agree">
						AlphaCar가 제공하는 이벤트/프로모션 알림 정보를 메일로 받습니다.
						<p>AlphaCar가 제공하는 이벤트/프로모션 알림 정보를 메일로 받습니다.
					...
					<div class="agree2">
						<label> 이벤트 등 프로모션 알림 메일 수신 <span class="optional">(선택)</span>
							<form:checkbox path="eventYn" value="Y" /> <form:errors
								path="eventYn" />
						</label>
					</div>
				</div>
					...
					<div style="float: right;">
						<button type="submit" class="next-btn">다 음 ▶</button>
					</div>
					</form:form>							
				</div>
		</div>
